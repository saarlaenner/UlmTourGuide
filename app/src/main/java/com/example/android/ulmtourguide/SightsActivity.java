...
import static com.example.android.ulmtourguide.R.color.category_sights;
...
public class SightsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        containerLayout.setBackgroundColor(getResources().getColor(R.color.category_sights));
